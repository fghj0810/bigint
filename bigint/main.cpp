...
void UBigInt2048_print(const bigint::UBigInt2048& num)
{
	uint8_t buffer[256];
	num.getBytes256(buffer);
...
int main()
{
	...
	bigint::UBigInt2048 a(aa, 256);
	UBigInt2048_print(a);
	bigint::UBigInt2048 b(bb, 256);
	UBigInt2048_print(b);
	//UBigInt2048_print(a + b);
	//UBigInt2048_print(a - b);
	//UBigInt2048_print(bigint::UBigInt2048 () - (b - a));
	//UBigInt2048_print(a * b);
	//UBigInt2048_print(a / b);
	//UBigInt2048_print(a >> 1024);
	//UBigInt2048_print(a << 1024);
	UBigInt2048_print(a / (bigint::UBigInt2048() + 1));
	UBigInt2048_print(a / b);
	UBigInt2048_print(b / a);

	std::cout << sizeof(bigint::UBigInt2048) << std::endl;
	return 0;
}