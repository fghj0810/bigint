...
void UBigInt2048_print(const bigint::BigUInt<2048>& num)
{
	uint8_t buffer[256];
	num.getBytes(buffer);
...
int main()
{
	...
	bigint::BigUInt<2048> a(aa, 256);
	UBigInt2048_print(a);
	bigint::BigUInt<2048> b(bb, 256);
	UBigInt2048_print(b);
	UBigInt2048_print(a + b);
	UBigInt2048_print(a - b);
	UBigInt2048_print(bigint::BigUInt<2048>() - (b - a));
	...
	UBigInt2048_print(a << 2044);
	UBigInt2048_print(a / a);
	UBigInt2048_print(a / (bigint::BigUInt<2048>() + 1));
	UBigInt2048_print(a / 1);
	UBigInt2048_print(a / (bigint::BigUInt<2048>() + 2));
	UBigInt2048_print(a / 2);
	UBigInt2048_print(a / b);
	UBigInt2048_print(b / a);
	bigint::BigUInt<2048> e((a >> 1024) * (b >> 1024));
	UBigInt2048_print(e / (b >> 1024));
	UBigInt2048_print(e / (a >> 1024));
	UBigInt2048_print(a % a);
	UBigInt2048_print(a % (bigint::BigUInt<2048>() + 1));
	UBigInt2048_print(a % 1);
	UBigInt2048_print(a % (bigint::BigUInt<2048>() + 2));
	...
	UBigInt2048_print(e % (b >> 1024));
	UBigInt2048_print(e % (a >> 1024));
	UBigInt2048_print((b >> 1024) % (a >> 1024));
	UBigInt2048_print((a >> 1024) / (b >> 1024));
	UBigInt2048_print((a >> 1024) % (b >> 1024));
	std::cout << sizeof(bigint::BigUInt<2048>) << std::endl;
	bigint::BigUInt<1024> t1(a);
	bigint::BigUInt<4096> t2(a);
	UBigInt2048_print(a);
